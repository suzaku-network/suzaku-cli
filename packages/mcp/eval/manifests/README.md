...
validity requires complete target scheduling and usage with no setup, ground-truth call/parse/
resolution defect (including `deep-global`), timeout, auth, run, drift, abort, or completeness
failure; it does not require quality PASSes.
