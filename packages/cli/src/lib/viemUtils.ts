export { setCastMode, isCastMode, withSafeWrite, withMulticall, getContract, contractAbiValidation } from '@suzaku-network/suzaku-sdk/node';
export type { EnhancedContract, SafeEnhancedContract } from '@suzaku-network/suzaku-sdk/node';

import type { EnhancedContract, SafeEnhancedContract } from '@suzaku-network/suzaku-sdk/node';
import type { ExtendedClient, ExtendedWalletClient } from '@suzaku-network/suzaku-sdk/node';
