...
(abi as any).contractName = 'VaultTokenized';

export async function getVaultTokenized<C extends ExtendedClient>(
  client: C,
  address?: Address,
): Promise<C extends ExtendedWalletClient ? SafeEnhancedContract<typeof abi, C> : EnhancedContract<typeof abi, C>> {
  return getContract(abi, 'VaultTokenized', client, address, selectors);
}

export type TVaultTokenizedABI = typeof abi;
export default abi;
