...
export async function getVaultManager<C extends ExtendedClient>(
  client: C,
  address?: Address,
): Promise<C extends ExtendedWalletClient ? SafeEnhancedContract<typeof abi, C> : EnhancedContract<typeof abi, C>> {
  return getContract(abi, 'VaultManager', client, address, selectors);
}
...
export type TVaultManagerABI = typeof abi;
export default abi;
