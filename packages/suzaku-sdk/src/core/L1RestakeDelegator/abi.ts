...
(abi as any).contractName = 'L1RestakeDelegator';

export async function getL1RestakeDelegator<C extends ExtendedClient>(
  client: C,
  address?: Address,
): Promise<C extends ExtendedWalletClient ? SafeEnhancedContract<typeof abi, C> : EnhancedContract<typeof abi, C>> {
  return getContract(abi, 'L1RestakeDelegator', client, address, selectors);
}

export type TL1RestakeDelegatorABI = typeof abi;
export default abi;
