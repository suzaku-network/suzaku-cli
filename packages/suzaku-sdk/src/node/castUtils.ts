...
export function logCastCall(
  ...
  nodeLogger.log(color.dim(`\n${cmd}\n`));
  nodeLogger.addData('cast', { mode: 'call', contract: contractName, function: functionName, address, args, cmd });
}
...
export function logCastSend(
  ...
  nodeLogger.log(color.cyan(`\n${cmd}\n`));
  nodeLogger.addData('cast', { mode: 'send', contract: contractName, function: functionName, address, args, cmd });
}
...
export function logPChainIssueTx(signedTxHex: Hex, rpcUrl: string): Hex {
  ...
  nodeLogger.log(color.cyan(`\n${cmd}\n`));
  nodeLogger.addData('cast', { mode: 'p-chain', function: 'platform.issueTx', cmd });
